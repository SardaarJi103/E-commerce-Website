...
<link rel="stylesheet" type="text/css" href="css/appliances.css">
...
if(request.getParameter("ac")!=null){%>
	...
	out.println("<script type=\"text/javascript\">");
	   ...
	   out.println("location='appliances.jsp=1';");
	   out.println("</script>");
	}else{
			out.println("<script type=\"text/javascript\">");
...
<div class="container-fluid" style="background-color: lightgray;">
  <h4 style="margin-left: 50px;">Home    |    <b>Appliances</b></h4>
</div>

  <h1 class="text-center product"><span style="color:#4082ed ">T</span>v <span style="color: #4082ed">&</span><span style="color: #4082ed"> L</span>cd</h1>
...
<% 
ps=conn.prepareStatement("select * from products where  product_home=2 and subcat_id=" + request.getParameter("aid") + " limit 0,3");
rs=ps.executeQuery();
while(rs.next()){
%>
  ...
  <div class="col-sm-6 col-md-4 botimage" >
    <div class="thumbnail">
      ...
      <div class="caption">
        <h3 class="tex-center"><%= rs.getString("name") %></h3>
        <h3 class="text-center"><span style="color: red">$ <% out.print(rs.getInt("price")-rs.getInt("discount")); %></span> <del>$ <%= rs.getInt("price") %></del></h3>
      
        <p><a href="appliances.jsp?ac=<%= rs.getString("id") %>" class="btn  cartbutton" role="button">Add To Cart</a></p>
      </div>
    </div>
  </div>
  <% } %>
...
<% 
ps2=conn.prepareStatement("select * from products where  product_home=2 and subcat_id=" + request.getParameter("aid") + " limit 3,3");
  ...
  <div class="col-sm-6 col-md-4 botimage" >
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <h3 class="text-center"><span style="color: red">$ <% out.print(rs2.getInt("price")-rs2.getInt("discount")); %></span> <del>$ <%= rs2.getInt("price") %></del></h3>
      
 <p><a href="appliances.jsp?ac=<%= rs2.getString("id") %>" class="btn  cartbutton" role="button">Add To Cart</a></p>      </div>
    </div>
  </div>
  <% } %>
</div>
...
<% 
ps3=conn.prepareStatement("select * from products where  product_home=2  and subcat_id="  + request.getParameter("aid")+ " limit 6,3");
...
%>
 ...
 <p><a href="appliances.jsp?ac=<%= rs3.getString("id") %>" class="btn  cartbutton" role="button">Add To Cart</a></p>     </div>
    </div>
  </div>
  <% } %>
</div>
...
<div class="row row2">
    ...
    <% 
ps4=conn.prepareStatement("select * from products where  product_home=2 and subcat_id=" + request.getParameter("aid") + " limit 9,3");
...
%>
  ...
  <p><a href="appliances.jsp?ac=<%= rs4.getString("id") %>" class="btn  cartbutton" role="button">Add To Cart</a></p>    </div>
    </div>
  </div>
  <% } } %>
</div>
...
<div id="div1" style="display: none;" class="text-center">
  <div class="checkbox">
  <label><input type="checkbox" value="">$1300 -$1500</label>
</div>
<div class="checkbox">
  <label><input type="checkbox" value="">$1550 - $1700</label>
</div>
<div class="checkbox ">
  <label><input type="checkbox" value="" disabled>$1750 - $2000</label>
</div>
<div class="checkbox">
  <label><input type="checkbox" value="">$2100 - $2500</label>
</div>
<div class="checkbox">
...
<div id="div11" style="display: none;" class="text-center">
  <div class="checkbox">
  <label><input type="checkbox" value="">Sony</label>
</div>
<div class="checkbox">
  <label><input type="checkbox" value="">Samsung</label>
</div>
<div class="checkbox">
  <label><input type="checkbox" value="">Hitachi</label>
</div>
<div class="checkbox">
  <label><input type="checkbox" value="">Acer</label>
</div>
<div class="checkbox">
