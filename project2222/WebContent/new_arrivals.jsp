...
<div class="container-fluid" style="background-color: lightgray;">
  <h4 style="margin-left: 50px;">Home    |    <b>New Arrivals</b></h4>
</div>

  <h1 class="text-center product"><span style="color:#4082ed ">N</span>ew <span style="color: #4082ed">A</span>rrivals</h1>
...
<% 
ps=conn.prepareStatement("select * from products where   subcat_id=7 limit 0,3");
rs=ps.executeQuery();
while(rs.next()){
%>
  ...
  <div class="col-sm-6 col-md-4 botimage" >
    <div class="thumbnail">
      ...
      <div class="caption">
       ...
       <p><a href="new_arrivals.jsp?ac=<%= rs.getString("id") %>" class="btn  cartbutton" role="button">Add To Cart</a></p>
      </div>
    </div>
  </div>
  <% } %>
...
<% 
ps2=conn.prepareStatement("select * from products where   subcat_id=7 limit 3,3");
  ...
  <div class="col-sm-6 col-md-4 botimage" >
    <div class="thumbnail">
      ...
      <div class="caption">
       ...
       <p><a href="new_arrivals.jsp?ac=<%= rs2.getString("id") %>" class="btn  cartbutton" role="button">Add To Cart</a></p>
  </div>
    </div>
  </div>
<% } %>
...
<% 
ps3=conn.prepareStatement("select * from products where   subcat_id=7 limit 6,3");
  ...
  <div class="col-sm-6 col-md-4 botimage" >
    <div class="thumbnail">
      ...
      <div class="caption">
       ...
       <p><a href="new_arrivals.jsp?ac=<%= rs3.getString("id") %>" class="btn  cartbutton" role="button">Add To Cart</a></p>
     </div>
    </div>
  </div>
<% } %>
...
<div class="row row2">
      ...
      <% 
ps4=conn.prepareStatement("select * from products where   subcat_id=7 limit 9,3");
  ...
  <div class="col-sm-6 col-md-4 botimage" >
    <div class="thumbnail">
      ...
      <div class="caption">
       ...
       <p><a href="new_arrivals.jsp?ac=<%= rs4.getString("id") %>" class="btn  cartbutton" role="button">Add To Cart</a></p>
     </div>
    </div>
  </div>
<% } %>
